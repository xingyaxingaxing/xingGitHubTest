 ...
 * subscribe实现订阅消费消息(开启两个线程订阅消息)
 */
public class MessageConsumerDui implements Runnable {
    public static final String CHANNEL_KEY = "channel:1";//频道

    public static final String EXIT_COMMAND = "exit";//结束程序的消息

    private MyJedisPubSubDui myJedisPubSub = new MyJedisPubSubDui();//处理接收消息
    ...
    public static void main(String[] args) {
        MessageConsumerDui messageConsumer = new MessageConsumerDui();
 ...
 */
class MyJedisPubSubDui extends JedisPubSub {
    @Override
    ...
    public void onMessage(String channel, String message) {
        ...
        //接收到exit消息后退出
        if (MessageConsumerDui.EXIT_COMMAND.equals(message)) {
            System.exit(0);
        }
    }
}